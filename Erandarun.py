...
\033[1;31;40m   ________  _________ _   _ _   _ 
\033[1;32;40m  |  ___|  \/  || ___ \ | | | \ | |
\033[1;33;40m  | |__ | .  . || |_/ / | | |  \| |
\033[1;34;40m  |  __|| |\/| ||    /| | | | . ` |
\033[1;35;40m  | |___| |  | || |\ \| |_| | |\  |
\033[1;36;40m  \____/\_|  |_/\_| \_|\___/\_| \_/
 \033[1;34;40m              Created by : ●ERANDA MALSHIKA●
\033[1;38;40m________________________________________________________________________
"""
print(name, "")
...
try:
    ...
    wr = str(input("\033[1;34;40m Paste Your Auth here :- "))
    f = open("auth.txt", "w")
    f.write(wr)
    f.close
    f = open("auth.txt", "r")
...
try:
    ...
    wr = str(input("\033[1;34;40m Paste Your URL here :- "))
    f = open("url.txt", "w")
    f.write(wr)
    f.close
    f = open("url.txt", "r")
...
def main():
    os.system("clear")
    print(name,"\n")
    s = int(input("\033[1;35;40m Enter Amount - "))
